...
import com.fc.pojo.PaidExample;
...
public interface PaidMapper {
    ...
    int addPaid(@Param("houseId") String houseId, @Param("date") String date, @Param("paydate") String paydate, @Param("userlistId") Integer userlistId, @Param("status") String status);
}