    ...
    <div class="sidebar-title">
        <form action="/paid/insertToPaid" method="post" id="myform" name="myform">
            <table class="insert-tab" width="100%">
                ...
                <td>
                    <input class="common-text required" value="${zulist.houseId}" id="house_id" name="houseId" size="50"
                           type="text" readonly>
                </td>
                </tr>
                <tr>
                    <th><i class="require-red">*</i>地址：</th>
                    <td><input class="common-text" name="address" value="${zulist.houselist.address }" id="address"
                ...
                <input type="hidden" name="userlistId" id="userlistId" value="${zulist.userlistId}"/>
                <tr>
                    <th></th>
                    <td>
